        ...
        .and_then(|cli_args| match cli_args {
            ...
            CliArgs {
                ...
                Ok(maybe_initialize_eth_core(
                    ...
                    cli_args.flag_confs,
                    "", // NOTE: This is the now-unused bytecode path arg!
                )?)
            },
            CliArgs {
            ...
            CliArgs {
                ...
                Ok(debug_get_perc20_migration_tx(get_db()?, &cli_args.arg_ethAddress)?)
            },
            CliArgs {
                ...
                Ok(debug_add_erc20_dictionary_entry(get_db()?, &cli_args.arg_entryJson)?)
            },
            CliArgs {
                ...
                Ok(debug_remove_erc20_dictionary_entry(
                    get_db()?,
                    &cli_args.arg_ethAddress,
                )?)
            },
            ...
            CliArgs {
                ...
                Ok(maybe_add_vault_contract_address_to_db(
                    &get_db()?,
                    &cli_args.arg_ethAddress,
                )?)
            },
